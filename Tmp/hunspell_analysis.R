...
#fifth stemming
# hunspell -i utf-8 -d fr_FR -m -G words_to_analize.txt > words_analiza_morfologiczna.txt
#file1 - morfologik analysis
#file2 - save analyzed
file1 <- "/dragon/Text-clustering-basing-on-string-metrics/Data/RObjects/words_analiza_morfologiczna.txt"
file2 <- "/dragon/Text-clustering-basing-on-string-metrics/Data/RObjects/words_analized.txt"
...
#sixth stemming
# hunspell -i utf-8 -d fr_FR -m -G words_to_analize_upper.txt > words_analiza_morfologiczna.txt
#file1 - morfologik analysis
#file2 - save analyzed
file1 <- "/dragon/Text-clustering-basing-on-string-metrics/Data/RObjects/words_analiza_morfologiczna.txt"
file2 <- "/dragon/Text-clustering-basing-on-string-metrics/Data/RObjects/words_analized.txt"
...
#seventh stemming
# hunspell -i utf-8 -d de_DE -m -G words_to_analize.txt > words_analiza_morfologiczna.txt
system2("hunspell", sprintf("-i utf-8 -d de_DE -m -G %s > %s", 
...
#eigth stemming
# hunspell -i utf-8 -d de_DE -m -G words_to_analize_upper.txt > words_analiza_morfologiczna.txt
system2("hunspell", sprintf("-i utf-8 -d de_DE -m -G %s > %s", 
