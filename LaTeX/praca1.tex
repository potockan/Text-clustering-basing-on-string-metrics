...
Zgromadzone dane to zbiór $1\ 075\ 568$ artykułów z polskiej Wikipedii z dnia $2.$ listopada $2014$ roku. Teksty składają się z treści sformułowanych w języku naturalnym, wzorów, linków wewnętrznych Wikipedii, linków do źródeł zewnętrznych, odniesień do źródeł bibliograficznych, cytatów, rysunków (zdjęć, wykresów) wraz z podpisami, tabel, komentarzy, uwag, tagów, sekcji ,,Zobacz też'' oraz kategorii.
