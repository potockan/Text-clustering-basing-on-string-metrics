...
\begin{defi}
Uogólniona \emph{odległością Levenshteina} na $\Sigma^*$ nazywamy:
$$
d_{lv}(s, t) = \left\{
\begin{array}{l l}     
    0, & \text{gdy } s = t = \varepsilon,\\
    min\{
    d_{lv}(s, t_{1:|t|-1}) + w_1,
    d_{lv}(s_{1:|s|-1}, t) + w_2,
...
Odległość ta zlicza ważoną sumę usunięć, wstawień oraz zamian znaków, potrzebnych do~przetworzenia jednego napisu w~drugi:
