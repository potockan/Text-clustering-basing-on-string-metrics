...
[TO DO - JESZCZE LICZE ROZNE WARIANTY]
...
W końcu spójrzmy na wartości jednorodności w podziale na użyty zbiór (skupień) słów. Najwyższą wartość jednorodności uzyskano dla zbiorów \emph{clust\_red\_jac} oraz \emph{clust\_red\_dl}, \emph{clust\_jac} i \emph{clust} dla, odpowiednio, podziale opartym na $2\%$, $15\%$ oraz $100\%$ zbioru. Wysoką wartość jednorodności uzyskano również dla \emph{clust\_lcs}, \emph{clust\_red\_lcs}, \emph{clust\_jac\_red\_jac}. Stąd też można wnioskować, że wpływ na jakość podziału miała procedura zmniejszająca liczbę skupień. Co więcej, najlepsze rezultaty uzyskano przy użyciu odległości Jaccarda oraz lcs. Warto przy tym zauważyć, że we wszystkich przypadkach najgorsze podziały uzyskano dla odległości $q$-gramowej.

Przejdźmy do analizy zgodności podziału zbiorów na skupienia. [TO DO]

\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=400pt]{plot6.pdf}\\
...
\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=400pt]{plot7.pdf}\\
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=400pt]{plot8.pdf}\\
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=400pt]{plot9.pdf}\\
