...
%Przykładowo, jeśli chcemy podzielić sześcioelementowy zbiór na trzy skupienia i $K = [1, 1, 2, 2, 3, 3]$, a $C = [2, 1, 3, 1, 2, 2]$, to $a = 1$, a $b = 9$. Stąd $\textrm{RI} = \frac{1+9}{{6 \choose 2} } \approx 0.67$.


%Miara ta nie gwarantuje, że losowy podział zbioru da wartość indeksu bliską zeru. Stąd, mamy \emph{skorygowany indeks Randa}~\cite{Lawrence1985:comparing}:
%\begin{equation}
%\textrm{ARI} = \frac{\textrm{RI} - \mathbb{E}(\textrm{RI}) }{\max{\textrm{RI}} - \mathbb{E}(\textrm{RI}) },
%\end{equation}
...
Do przeprowadzenia \emph{stemmingu} używamy programu \emph{Hunspell}~\footnote{\url{http://hunspell.sourceforge.net/}} -- korektora pisowni i analizatora morfologicznego używany w wielu programach typu \emph{open source}. W ten sposób grupujemy $746\ 942$ słów, co stanowi ok. $27\%$ wszystkich słów, w $186\ 958$ skupienia. Ponieważ część wyrazów stanowią słowa obcojęzyczne przeprowadzamy \emph{stemming} w języku polskim, angielskim, niemieckim oraz francuskim (p. tabela~\ref{tab:002}). Przykładowe skupienia prezentuje tabela~\ref{tab:003}. Warto zauważyć, że słowa w podzbiorach są podobne tematycznie, choć do skupienia o reprezentancie \verb|główny| trafiły wyrazy o znaczeniu przeciwnym. Widać więc, że podział taki nie jest idealny.
...
\begin{tabular}{rllrrrrr}
 ...
 & Typ danych & Batch & Jedn. & Zup. & Miara V & ARI & Silhouettes \\ 
  \hline
1 & \_ & 5000 & 0.19 & 0.51 & 0.27 & 0.01 & -0.19 \\ 
  2 & \_ & 10000 & 0.19 & 0.50 & 0.28 & 0.01 & -0.19 \\ 
  3 & \_ & 35000 & 0.22 & 0.53 & 0.31 & 0.02 & -0.20 \\ 
  4 & \_ & 70000 & 0.22 & 0.52 & 0.31 & 0.02 & -0.19 \\ \hline
  5 & \_lcs & 5000 & 0.17 & 0.51 & 0.26 & 0.01 & -0.22 \\ 
  6 & \_lcs & 10000 & 0.17 & 0.51 & 0.26 & 0.01 & -0.21 \\ 
  7 & \_lcs & 35000 & 0.18 & 0.53 & 0.27 & 0.01 & -0.21 \\ 
  8 & \_lcs & 70000 & 0.19 & 0.52 & 0.28 & 0.01 & -0.24 \\ \hline
  9 & \_dl & 5000 & 0.20 & 0.51 & 0.28 & 0.01 & -0.20 \\ 
  10 & \_dl & 10000 & 0.19 & 0.51 & 0.27 & 0.01 & -0.20 \\ 
  11 & \_dl & 35000 & 0.21 & 0.52 & 0.30 & 0.02 & -0.20 \\ 
  12 & \_dl & 70000 & 0.22 & 0.53 & 0.31 & 0.01 & -0.22 \\ \hline
  ...
  16 & \_jaccard & 70000 & 0.21 & 0.51 & 0.30 & 0.01 & -0.22 \\ \hline
  17 & \_qgram & 5000 & 0.18 & 0.50 & 0.26 & 0.01 & -0.22 \\ 
  18 & \_qgram & 10000 & 0.18 & 0.47 & 0.26 & 0.02 & -0.21 \\ 
  19 & \_qgram & 35000 & 0.21 & 0.52 & 0.30 & 0.02 & -0.22 \\ 
  20 & \_qgram & 70000 & 0.19 & 0.49 & 0.28 & 0.01 & -0.19 \\ \hline
  21 & \_red\_lcs & 5000 & 0.19 & 0.54 & 0.29 & 0.01 & -0.21 \\ 
  22 & \_red\_lcs & 10000 & 0.20 & 0.51 & 0.28 & 0.01 & -0.21 \\ 
  23 & \_red\_lcs & 35000 & 0.22 & 0.53 & 0.31 & 0.02 & -0.13 \\ 
  24 & \_red\_lcs & 70000 & 0.24 & 0.52 & 0.32 & 0.03 & -0.18 \\ \hline
  25 & \_red\_dl & 5000 & 0.20 & 0.53 & 0.29 & 0.01 & -0.21 \\ 
  26 & \_red\_dl & 10000 & 0.21 & 0.51 & 0.29 & 0.02 & -0.19 \\ 
  27 & \_red\_dl & 35000 & 0.21 & 0.51 & 0.30 & 0.02 & -0.15 \\ 
  28 & \_red\_dl & 70000 & 0.24 & 0.53 & 0.33 & 0.02 & -0.19 \\ \hline
  29 & \_red\_jaccard & 5000 & 0.20 & 0.48 & 0.28 & 0.01 & -0.17 \\ 
  30 & \_red\_jaccard & 10000 & 0.22 & 0.51 & 0.31 & 0.02 & -0.21 \\ 
  31 & \_red\_jaccard & 35000 & 0.22 & 0.51 & 0.30 & 0.02 & -0.20 \\ 
  32 & \_red\_jaccard & 70000 & 0.22 & 0.51 & 0.31 & 0.01 & -0.21 \\ \hline
  33 & \_red\_qgram & 5000 & 0.18 & 0.41 & 0.25 & 0.02 & -0.10 \\ 
  34 & \_red\_qgram & 10000 & 0.19 & 0.42 & 0.26 & 0.02 & -0.11 \\ 
  35 & \_red\_qgram & 35000 & 0.20 & 0.42 & 0.27 & 0.02 & -0.12 \\ 
  36 & \_red\_qgram & 70000 & 0.20 & 0.42 & 0.27 & 0.02 & -0.11 \\ \hline
  37 & \_red\_lcs\_lcs & 5000 & 0.18 & 0.52 & 0.26 & 0.01 & -0.23 \\ 
  38 & \_red\_lcs\_lcs & 10000 & 0.18 & 0.57 & 0.27 & 0.01 & -0.25 \\ 
  39 & \_red\_lcs\_lcs & 35000 & 0.18 & 0.55 & 0.27 & 0.01 & -0.23 \\ 
  40 & \_red\_lcs\_lcs & 70000 & 0.23 & 0.57 & 0.33 & 0.01 & -0.24 \\ \hline
  41 & \_red\_dl\_dl & 5000 & 0.18 & 0.54 & 0.27 & 0.01 & -0.18 \\ 
  42 & \_red\_dl\_dl & 10000 & 0.21 & 0.57 & 0.31 & 0.01 & -0.26 \\ 
  43 & \_red\_dl\_dl & 35000 & 0.20 & 0.58 & 0.30 & 0.01 & -0.26 \\ 
  44 & \_red\_dl\_dl & 70000 & 0.23 & 0.57 & 0.33 & 0.01 & -0.21 \\ \hline
  45 & \_red\_jaccard\_jaccard & 5000 & 0.19 & 0.48 & 0.27 & 0.01 & -0.15 \\ 
  46 & \_red\_jaccard\_jaccard & 10000 & 0.20 & 0.50 & 0.29 & 0.01 & -0.24 \\ 
  47 & \_red\_jaccard\_jaccard & 35000 & 0.22 & 0.51 & 0.31 & 0.02 & -0.21 \\ 
  48 & \_red\_jaccard\_jaccard & 70000 & 0.23 & 0.52 & 0.32 & 0.02 & -0.21 \\ \hline
  49 & \_red\_qgram\_qgram & 5000 & 0.17 & 0.45 & 0.25 & 0.01 & -0.21 \\ 
  50 & \_red\_qgram\_qgram & 10000 & 0.19 & 0.46 & 0.26 & 0.01 & -0.21 \\ 
  51 & \_red\_qgram\_qgram & 35000 & 0.20 & 0.47 & 0.28 & 0.01 & -0.20 \\ 
  52 & \_red\_qgram\_qgram & 70000 & 0.18 & 0.45 & 0.26 & 0.01 & -0.16 \\ 
   \hline
\end{tabular}
\end{table}
...
\begin{tabular}{rllrrrrr}
 ...
 & Typ danych & Batch & Jedn. & Zup. & Miara V & ARI & Silhouettes \\ 
  \hline
1 & \_ & 5000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.20 \\ 
  2 & \_ & 10000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.23 \\ 
  3 & \_ & 35000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.17 \\ 
  4 & \_ & 70000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.22 \\ \hline
  5 & \_lcs & 5000 & 0.02 & 0.07 & 0.04 & 0.00 & -0.20 \\ 
  6 & \_lcs & 10000 & 0.02 & 0.06 & 0.04 & 0.00 & -0.23 \\ 
  7 & \_lcs & 35000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.19 \\ 
  8 & \_lcs & 70000 & 0.02 & 0.06 & 0.03 & -0.00 & -0.19 \\ \hline
  9 & \_dl & 5000 & 0.02 & 0.06 & 0.04 & 0.00 & -0.20 \\ 
  10 & \_dl & 10000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.22 \\ 
  11 & \_dl & 35000 & 0.02 & 0.07 & 0.03 & -0.00 & -0.23 \\ 
  12 & \_dl & 70000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.22 \\ \hline
  ...
  16 & \_jaccard & 70000 & 0.02 & 0.05 & 0.03 & 0.00 & -0.17 \\ \hline
  17 & \_qgram & 5000 & 0.02 & 0.06 & 0.04 & 0.00 & -0.20 \\ 
  18 & \_qgram & 10000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.22 \\ 
  19 & \_qgram & 35000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.19 \\ 
  20 & \_qgram & 70000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.22 \\ \hline
  21 & \_red\_lcs & 5000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.19 \\ 
  22 & \_red\_lcs & 10000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.17 \\ 
  23 & \_red\_lcs & 35000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.15 \\ 
  24 & \_red\_lcs & 70000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.21 \\ \hline
  25 & \_red\_dl & 5000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.19 \\ 
  26 & \_red\_dl & 10000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.16 \\ 
  27 & \_red\_dl & 35000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.19 \\ 
  28 & \_red\_dl & 70000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.19 \\ \hline
  29 & \_red\_jaccard & 5000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.17 \\ 
  30 & \_red\_jaccard & 10000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.17 \\ 
  31 & \_red\_jaccard & 35000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.18 \\ 
  32 & \_red\_jaccard & 70000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.17 \\ \hline
  33 & \_red\_qgram & 5000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.12 \\ 
  34 & \_red\_qgram & 10000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.09 \\ 
  35 & \_red\_qgram & 35000 & 0.03 & 0.05 & 0.03 & 0.00 & -0.09 \\ 
  36 & \_red\_qgram & 70000 & 0.02 & 0.05 & 0.03 & 0.00 & -0.10 \\ \hline
  37 & \_red\_lcs\_lcs & 5000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.17 \\ 
  38 & \_red\_lcs\_lcs & 10000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.19 \\ 
  39 & \_red\_lcs\_lcs & 35000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.22 \\ 
  40 & \_red\_lcs\_lcs & 70000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.19 \\ \hline
  41 & \_red\_dl\_dl & 5000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.25 \\ 
  42 & \_red\_dl\_dl & 10000 & 0.03 & 0.07 & 0.04 & 0.00 & -0.20 \\ 
  43 & \_red\_dl\_dl & 35000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.23 \\ 
  44 & \_red\_dl\_dl & 70000 & 0.02 & 0.06 & 0.04 & 0.00 & -0.20 \\ \hline
  45 & \_red\_jaccard\_jaccard & 5000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.22 \\ 
  46 & \_red\_jaccard\_jaccard & 10000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.21 \\ 
  47 & \_red\_jaccard\_jaccard & 35000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.20 \\ 
  48 & \_red\_jaccard\_jaccard & 70000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.16 \\ \hline
  49 & \_red\_qgram\_qgram & 5000 & 0.02 & 0.06 & 0.03 & 0.00 & -0.17 \\ 
  50 & \_red\_qgram\_qgram & 10000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.16 \\ 
  51 & \_red\_qgram\_qgram & 35000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.16 \\ 
  52 & \_red\_qgram\_qgram & 70000 & 0.03 & 0.06 & 0.04 & 0.00 & -0.19 \\ 
   \hline
\end{tabular}
\end{table}
...
\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=350pt, height=200pt]{plot5.pdf}\\
...
\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=350pt, height=200pt]{plot6.pdf}\\
  \caption{Zupełność.}\label{plot:006}
\end{figure}

\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=350pt, height=200pt]{plot7.pdf}\\
...
\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=350pt, height=200pt]{plot8.pdf}\\
...
\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=350pt, height=200pt]{plot9.pdf}\\
