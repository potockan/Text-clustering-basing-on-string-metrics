...
\item Spis treści zawiera tematów, które są następnie powtórzone w tekście.
...
Wstępną obróbkę danych przeprowadzono uwzględniając powyższe aspekty. Początkowo z części tekstowej usunięto wszystkie znaki nie będące literami alfabetu łacińskiego [ŁACIŃSKIEGO CZY JAKIEGOŚ INNEGO?
BYŁO O TAK:
\begin{verbatim}
...
Te i podobne słowa oraz wyrazy jedno- i dwuznakowe, należy usunąć ze zbioru danych, gdyż nie wnoszą żadnej istotnej informacji o tematyce tekstu. Uczyniono to w dalszej części wstępnej obróbki tekstów, co zostanie opisane poniżej.

Średnia liczba unikalnych słów występujących w artykule wynosi $121$, mediana to zaledwie $66$ unikalnych wyrazów. W $2272$ tekstach wystąpiło mniej niż pięć słów. Artykuły te zawierały przede wszystkim tabele i rysunki, stąd po wstępnej obróbce danych pozostało w nich niewiele wyrazów. Histogram logarytmu dziesiętnego liczby unikalnych słów w tekstach przedstawia rys.~\ref{plot:004}.
