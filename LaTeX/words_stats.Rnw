...
<<ws_all>>=
word_stat_all <- readRDS("../Data/RObjects/words_cnt_all.rds")
...
<<hist, dependson='ws'>>=
ggplot(word_stat, aes(x=word_cnt), main="Liczba występowania słów w artykułach") +  geom_histogram(fill="white", colour="black")
@
